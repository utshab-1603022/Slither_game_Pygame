...
def gameLoop():
    ...
    while not gameExit:
        ...
        if x>=display_width or y<0 or y>=display_height or y<0:
            #gameExit = True
            gameOver = True
        ...
        gameDisplay.fill(white)
        #new
        pygame.draw.rect(gameDisplay, red, [randAppleX,randAppleY, block_size, block_size])  #[] indicates how long/wide the apple would be
